...
export const Card = () => {
  ...
  return (
    <div className="w-full  relative   h-full  p-6 items-center  rounded-xl mt-6  flex flex-col  gap-2  bg-customGrey-300 lg:max-w-[22rem] lg:items-start lg:h-[32rem]  ">
      <button
        onClick={toggle}
        className=" absolute left-4 top-4 bg-customGrey-550 px-[0.35rem]  border border-customGrey-650 rounded-full hover:bg-blue-500 "
      >
      ...
      <div className="flex flex-col gap-4   ">
        ...
        {/* <button className=" min-w-4 relative -left-[17vw] rounded-lg text-white  bg-customGrey-550 hover:bg-customGrey-500 justify-center text-sm transition-colors   h-9 px-4 py-2  flex items-center gap-1 f">
