...
export const Modal = ({ modal, setModal }) => {
  ...
  return (
    <>
      ...
      {/* Modal Content */}
      <div
        className={`relative bg-customGrey-400 border border-customGrey-650 rounded-xl p-1 max-w-[21rem] w-full z-50 max-h-[80vh] overflow-y-auto transition-transform   ${
      ...
      >
        <div className="flex  justify-between items-center mb-4 lg:mb-2">
          ...
          <button className="lg:hidden" onClick={() => setModal(false)}>
